...
export class GameManager extends Component {
    ...
    update(deltaTime: number) {
        ...
        if (this._combinationInterval === Constant.Combination.PLAN1) {//前10s
            ...
            //     if (this._currCreateEnemyTime > this.createEnemyTime * 0.8) {//增加时间减少出现频率
            //         const randomCombination = 4;//必为boss
    ...
    public createEnemyPlane() {
        ...
        } else if (whichEnemy === Constant.EnemyType.TYPE1) {
            prefab = this.enemy02;
    ...
    public creteCombination3() {
        ...
        boss.setPosition(0.8, 0, -34);//每架飞机之间间隔10
        const enemyComp = boss.getComponent(Boss);
        enemyComp.show(this, 0, true);//设置飞行速度    //组合飞机不发射子弹
    }
