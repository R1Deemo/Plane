...
export class GameManager extends Component {
    ...
    public createEnemyBullert(targetPos: Vec3) {
        ...
        // //给敌机子弹设置分组
        // const colideComp = bullet.getComponent(BoxCollider);
        // colideComp.setGroup(Constant.CollisionType.ENEMY_BULLET);
        // colideComp.setMask(Constant.CollisionType.SELF_BULLET);
    }
